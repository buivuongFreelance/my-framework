...
function loopCallbackJs(i, files, self) {
	if (i < files.length) {
		$.getScript(files[i]).done(function (script, textStatus) {}).fail(function (jqxhr, settings, exception) {
...
var CSS = {
	'bootstrap-select': _config.DEFAULT_URL + 'metronic/assets/global/plugins/bootstrap-select/css/bootstrap-select.css'
};
...
var JS = {
	'bootstrap-select': _config.DEFAULT_URL + 'metronic/assets/global/plugins/bootstrap-select/css/bootstrap-select.js'
};
