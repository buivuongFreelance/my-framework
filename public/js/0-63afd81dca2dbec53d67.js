...
exports.default = (0, _Script2.default)(['a.css', 'b.css', 'c.css'], ['a.js', 'b.js', 'c.js'])(UserSignIn);
	...
	return function (ComposedComponent) {
		var Script = function (_Component) {
			...
			_createClass(Script, [{
				...
				value: function componentDidMount() {
					console.log(params);
					loopCallbackCss(0, params.css, this);
					loopCallbackJs(0, params.js, this);
				}
			}, {
				key: 'render',
				value: function render() {
